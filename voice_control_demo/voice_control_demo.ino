...
static const char *ACCESS_KEY = "f0VCK3M9XrX8mWeCr8skiYifJRg3yp5BQYPzFN+1b2X0dm81ayGYUQ=="; // AccessKey string obtained from Picovoice Console (https://picovoice.ai/console/)
